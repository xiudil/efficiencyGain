...
### dat is a data.frame with the following columns: time, censoring status, covariate W, 1-censoring status
### tt: estimate the nuisance functions from time 0 to time tt
### method: coxph = sequence of coxph models + BIC
###         super = super learning without cross-fitting
