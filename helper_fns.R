...
### find true coefficients in proportional odds model by solving estimating equations
### this function takes in a set of coefficients and outputs the corresponding values of the estimating equation
...
### fit proportional odds model by recasting into a logistic regression
...
# and outputs the estimated cdf and pmf conditional on covariate
